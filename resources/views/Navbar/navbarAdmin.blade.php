                    ...
                    <ul class="navbar-nav ms-auto gap-1">
                        <li class="nav-item">
                            <a href="{{ route('dashboard') }}"
                                class="nav-link text-black px-3 py-2 d-flex align-items-center {{ request()->routeIs('dashboard') ? 'bg-white bg-opacity-10' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="{{ route('reservations') }}"
                                class="nav-link text-black px-3 py-2 d-flex align-items-center {{ request()->routeIs('reservations') ? 'bg-white bg-opacity-10' : '' }}">
                            ...
                            <ul class="dropdown-menu border-0 shadow">
                                <li>
                                    <a class="dropdown-item py-2" href="{{ route('rooms') }}">
                                        Room
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item py-2" href="{{ route('addActivities') }}">
                                        Activities
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('guests') }}"
                                class="nav-link text-black px-3 py-2 d-flex align-items-center {{ Request::routeIs('staff.guests') ? 'active bg-white bg-opacity-10' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('transactions') }}"
                                class="nav-link text-black px-3 py-2 d-flex align-items-center {{ request()->routeIs('transactions') ? 'bg-white bg-opacity-10' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link text-black px-3 py-2 d-flex align-items-center"
